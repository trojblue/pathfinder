...
class BcyAPI():
    ...
    def __init__(self, base_url="https://bcy.net", endpoint="/apiv3/rank/list/itemInfo",
                 short_break=(1, 0.1), long_break=(5, 0.5), fraction_break=(0.1, 0.01)):
    ...
    def _make_request(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            with self.session.get(self.base_url + self.endpoint, params=params) as response:
    ...
    def _save_response(self, response: Dict[str, Any], target_dir: str, params: Dict[str, Any]) -> None:
    ...
    def fetch_data(self, parameters: List[Dict[str, Any]], target_dir: str) -> None:
        ...
        futures_params = {self.executor.submit(self._make_request, params): params for params in parameters}
